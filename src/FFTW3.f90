...
!!----------IDRIS Jean-Zay-------------
!include '/gpfslocalsup/spack_soft/fftw/3.3.8/intel-19.0.4-ifhmvtovzozeif6roxv5xyn2cmo5grlq/include/fftw3-mpi.f03'
!!---------CICADA Unice-----------------
...
!!-------SNBOSE PHYS IITKGP----------
!include '/home/vshukla/softwares/fftw/fftw-3.3.8_intel/include/fftw3-mpi.f03'
end module FFTW3
